   ...
   //[Authorize(Policy = "AdminRolePolicy")]
    public class AdministrationController : Controller
    {
        ...
        public async Task<IActionResult> EditRole(string id)
        {
            ...
            // Got multiple reader open error so added 
            // MultipleActiveResultSets=true inconnection string 
            // then this block of code will work or use the 
            // below code..
        ...
        public async Task<IActionResult> DeleteRole(string id)
        {
            ...
            try
            {
                ...
                ViewBag.ErrorMessage = $"{role.Name} role cannt be deleted as there are users in this role.";
                return View("Error");
            }
        }
        [HttpGet]
